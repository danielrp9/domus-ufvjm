...
export default function FormsManutencaoPC() {
  ...
  const handleSubmit = () => {
    ...
    console.log('Solicitação enviada:', { tipo: 'PC', blocoApto, descricao });
    Alert.alert('Solicitação Enviada', 'Sua solicitação de manutenção em PC foi registrada.');
  ...
  return (
    <ScrollView style={styles.scrollView} contentContainerStyle={styles.container}>
      ...
      <View style={styles.subtitleContainer}>
        ...
        <Text style={styles.subtitle}>Manutenção em PC</Text>
      </View>
