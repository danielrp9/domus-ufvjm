...
export default function FormsManutencaoHidraulica() {
  ...
  const handleSubmit = () => {
    ...
    console.log('Solicitação enviada:', { tipo: 'Hidráulica', blocoApto, descricao });
    Alert.alert('Solicitação Enviada', 'Sua solicitação de manutenção hidráulica foi registrada.');
  ...
  return (
    <ScrollView style={styles.scrollView} contentContainerStyle={styles.container}>
      ...
      <View style={styles.subtitleContainer}>
        ...
        <Text style={styles.subtitle}>Manutenção Hidráulica</Text>
      </View>
